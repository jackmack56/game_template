                ...
                <div class="new-box-1 col-6 col-lg-2 col-md-4">
                    <a href="/details/${game.id}" style="text-decoration: none">
                        ...
                        <div class="new-box-des-1 mt-2">
                            ...
                            <p style="color:red; font-size: 12px; line-height: 5rem;">${game.gameHot}</p>
                        </div>
                    </a>
                </div>
...
<section style="margin-top: 2rem">
    <div class="w-100">
        <h2  style="font-weight: bolder; font-size: 40px;">Random <span style="color: #f88d1e">Games</span></h2>
        <hr>
    </div>
    <div class="row w-95 mx-auto mt-5">
        <#list all_game as game>
            <#if 6 < game_index  && game_index < 16>
