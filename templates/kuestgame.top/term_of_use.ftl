    ...
    <div class="container">
        <div class="row">
            <div data-v-362b6a26="" class="main-wrap">
                ...
                <p>By using or accessing the Websites and Services, you are accepting the Terms of Use. ${advert.serviceName}
                ...
                <p>The Websites include references and hyperlinks to websites of third parties and provide access to
                    games and services of business partners of ${advert.serviceName}. Although ${advert.serviceName} selects its
                    business partners carefully, ${advert.serviceName} does not provide any warranty and accepts no
                    responsibility regarding the content, use and availability of websites of its business partners or
                    other third parties. You acknowledge and agree that the websites of ${advert.serviceName}'s business
                    ...
                    services of third parties. Any dealings that you have with ${advert.serviceName}'s business partners or
                    other third parties (e.g. third party advertisers found on the Website) are between you and the
                    third party. You acknowledge and agree that ${advert.serviceName} is not liable for any loss or claim you
                ...
                <p>Please see the Privacy relating to the collection and use of your personal data. Please review these
                    policies prior to using the Services.</p>
                <h3>4. PERSONAL AND NON-COMMERCIAL USE LIMITATION</h3>
                <p>Unless otherwise specified, the Services are for your personal and non-commercial use. You may not
                ...
                <p>In no event shall ${advert.serviceName} be liable for any special, indirect or consequential damages or any
                ...
                <p>All Services are provided “as is”, with all faults and if and as available. ${advert.serviceName} makes no
                    warranties or guarantees in respect of the Services. ${advert.serviceName} is not obligated to provide any
                    support whatsoever. ${advert.serviceName} does not guarantee that the Services will meet your
                    requirements, is error-free, reliable, without interruption or available at all
                    times. ${advert.serviceName} does not guarantee that the results that may be obtained from the use of the
                ...
                <p>As a condition of your use of the Services, you will not use the Services for any purpose that is
                    ...
                    damage, disable, overburden, or impair any ${advert.serviceName} server, ${advert.serviceName}'s business
                    ...
                    Services, other accounts, computer systems or networks connected to any ${advert.serviceName}
                    server, ${advert.serviceName}'s business partner's server or to any of the Services, through hacking, or
                ...
                <p>By way of example, and not as a limitation, you agree that when using the Services, you will not:
                    ...
                    <br/><br/>
                    ${advert.serviceName} reserves the right to take technical and legal measures to enforce compliance of the
                    Terms of Use, without notice, for any reason whatsoever.
                    <br/><br/>
                    ${advert.serviceName} reserves the right at all times to disclose any information as ${advert.serviceName} deems
                    ...
                    in ${advert.serviceName}'s sole discretion.
                </p>
            </div>
        </div>
    </div>
