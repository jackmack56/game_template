  ...
  <div class="container">
    <div class="row">
      <div data-v-362b6a26="" class="main-wrap">
        ...
        <p>The Websites include references and hyperlinks to websites of third parties and provide access to games and services of business partners of ${service_name}. Although ${service_name} selects its business partners carefully, ${service_name} does not provide any warranty and accepts no responsibility regarding the content, use and availability of websites of its business partners or other third parties. You acknowledge and agree that the websites of ${service_name}'s business partners and other third party websites are governed by its own terms and conditions, such as terms of use, privacy statement and cookie statement. Please review these policies prior to using the services of third parties. Any dealings that you have with ${service_name}'s business partners or other third parties (e.g. third party advertisers found on the Website) are between you and the third party. You acknowledge and agree that ${service_name} is not liable for any loss or claim you may have against such third party.</p>
        ...
        <p>In no event shall ${service_name} be liable for any special, indirect or consequential damages or any damages whatsoever, whether in an action of contract, negligence or other tortious action, arising out of or in connection with the use or provision of or failure to provide the Services, or information available from the Services.</p>
        <h3>6. NO GUARANTEE AND SUPPORT</h3>
        <p>All Services are provided “as is”, with all faults and if and as available. ${service_name} makes no warranties or guarantees in respect of the Services. ${service_name} is not obligated to provide any support whatsoever. ${service_name} does not guarantee that the Services will meet your requirements, is error-free, reliable, without interruption or available at all times. ${service_name} does not guarantee that the results that may be obtained from the use of the Services will be effective, reliable, and accurate or will meet your requirements.</p>
