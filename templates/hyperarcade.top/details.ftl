...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-0 main">
    <div class="show-top-grids">
        <div class="w-100 single-left">
            <div class="song">
                <div class="song-info">
                    <h3 style="font-weight: bolder">${game.gameName}</h3>
                </div>
                <div class="video-grid">
                    <a href="${game.gameUri}"><img src="${game.gamePreview}"
                                                   style="width: 100%; height: 100%; border-radius: 15px"/></a>
                </div>
            </div>
            <div class="clearfix"></div>
            <p style="width: 20rem; height: 5rem;  font-size: 20px;  margin: 5px auto; font-weight: bolder; background: white; border-radius: 25px; text-align: center; line-height: 5rem">
                <a href="${game.gameUri}" style="color: red">Play</a>
            </p>
            <div class=" published">
                <div class="load_more">
                    <ul id="myList">
        ...
        <#list alikeGame as game>
            ...
            <div class="col-md-2 col-lg-2 resent-grid recommended-grid slider-top-grids ">
                ...
                <div class="resent-grid-info recommended-grid-info">
                    <ul>
                        <li><p class="author author-info"><a href="/details/${game.id}"
                                                             class="author">${game.gameName}</a></p></li>
                    </ul>
                </div>
            </div>
        </#list>
