      ...
      <div class="game-box game-deskbox game-responsive">
        <a href="${game.gameUri}" id="as-play-btn">
          ...
          <div style="width:164px; z-index:2;"><img src="${game.gamePreview}" alt="donut box game" class="shadow"
              width="164" height="164" style="display: block; border-radius: 50%;object-fit: cover;" loading="lazy">
            <div class="btn btn-block btn-lg btn-warning mt-2 shadow as-cta"><svg width="8" height="20"
              ...
              <#if hotValue < 4>
                <a href="/details/${game.id}" class="as-game-box as-related-game">
                  <div class="as-related-resize"><img
                      ...
                      data-loaded="true"></div><span class="as-game-box-title as-related-title">${game.gameName}</span>
                </a>
                <#assign hotValue++>
              </#if>
            </#list>
