<html lang="en">
  ...
  <body class="dark-mode">
    <header id="page-header" class="fixed-top">
      <div
        class="d-none d-lg-flex w-100 px-40 align-items-center justify-content-between"
      >
          ...
          <a href="/" class="navbar-brand"
            ...
            >
              ...
              <g clip-path="url(#clip0)">
                ...
                ></path>
                <path
                  d="M3.00488 29.3562C3.05414 29.4298 3.10341 29.4788 3.15267 29.5279L11.4286 17.2655"
                  fill="#00BDFF"
                ></path>
              </g>
              <defs>
      ...
      <div
        class="d-flex d-lg-none w-100 px-16 align-items-center justify-content-between overflow-hidden"
      >
        <nav
          class="navbar navbar-expand navbar-light white-space-no-wrap svg-menu-animate w-100"
        >
          <a href="/domain/${advert.domain}/index.html" class="navbar-brand"
            ><svg
              width="126"
              height="29"
              viewBox="0 0 176 40"
          ...
          ></a>
          <ul
            class="navbar-nav pl-24 w-100 align-items-center position-relative"
          >
            <li class="nav-item active">
    ...
    <main id="main-content" class="header-spacing">
      ...
      <div class="container pt-16 pb-32 pt-md-96 pb-md-48 order-5 order-md-6">
        ...
        <div class="row">
          <#assign adventureValue = 0>
          <#list all_game as game>
            <#if "Adventure" ==  game.gameCategory &&  adventureValue < 12>
