...
<body class="dark-mode">
  ...
  <main id="main-content" class="header-spacing">
    <div style="text-align: center;display: flex;flex-direction: column;align-items: center;margin-top:10%;">
      <div style="display: flex;justify-content: center;">
        <img src="${game.gamePreview}" width="132" height="132" class="app-logo">
      </div>
      <div style="width: 70%;">
        <h1 style="margin-top: 24px;" class="truncate"></h1>
        <div style="display: flex;justify-content: center;">
        ...
        <div style="margin-top: 60px;">
          <a href="${game.gameUri}" style="display: inline-block; padding: 16px; font-weight: bold; color: white;background: #ff0029; min-width: 260px;  border-radius: 12px;">
            Play
          </a>
        </div>
      </div>
      <div class="dsc" style="margin-top:30px;width:80%;">
        ${game.gameDesc}
      </div>
    </div>
  ...
  <div class="container pt-16 pb-32 pb-md-48 order-5 order-md-6" style="margin-top: 40px;">
    <div class="row border-bottom-light-grey-row align-items-center pb-8 pb-md-16">
      ...
      <div class="col-3 text-right">
        <a href="/type/${game.gameCategory}" class="text-primary font-secondary text-decoration-none">See All</a>
      </div>
    </div>
    <div class="row">
          ...
          <div class="row align-items-center">
            <div class="col-3 col-md-12">
              <div class="img-mb-sm img-dt-md">
                <span><img width="192" height="192" src="${game.gamePreview}" class="img-fluid game-icon"></span>
              </div>
            </div>
