    ...
    <div style="text-align: center;display: flex;flex-direction: column;align-items: center;margin-top:10%;">
        ...
        <div style="width: 70%;">
            ...
            <div style="margin-top: 60px;">
                <a href="${game.gameUri}"
                   style="display: inline-block; padding: 16px; font-weight: bold; color: white;background: #ff0029; min-width: 260px;  border-radius: 12px;">
                    Play
                </a>
            </div>
        </div>
...
<footer id="page-footer" class="container-fluid py-30 pt-md-96 pb-md-42 px-16 px-md-40 bg-light">
    ...
    <div class="row pt-32 pt-md-50 flex-column flex-md-row">
        <div class="col-lg-6" style="margin: 0 auto;">Copyright © 2024 <a href="/">${advert.serviceName}</a>. All Rights
            Reserved.
        </div>
    </div>
</footer>
